...
#
#So I went to the swcausfsv02 server and did "net use \\ussighnynt12.us.int.sonichealthcare\imports /delete /y" there and it 
#fixed it.
#So I added net use \\ussighnynt12.us.int.sonichealthcare\imports /delete /y at the beginning of the batch file to delete any 
#connections there in case.
